...
precompress:
	...
	find . -type f -iname "*.min.js"   -exec brotli --force --best --keep {} \;
	...
	find . -type f -iname "*.min.js"   -exec zstd   --force --keep --threads=4 --no-progress --quiet {} \;
	...
	find . -type f -iname "*.min.js"   -exec gzip   --force --keep --quiet {} \;
...
minify:
	...
	jsmin < assets/javascript/degruchy.org.js > assets/javascript/degruchy.org.min.js

upload:
	rsync --recursive --update --delete-excluded --delete-after --exclude=Makefile --exclude=.editorconfig --exclude=.fslckout --exclude=templates --exclude=assets/javascript/degruchy.org.js --exclude=README.md --exclude="*.original.*" --progress . nathan@degruchy.org:~/blog
...
clean:
	...
	find . -type f -iname "degruchy.org.min.js" -delete
