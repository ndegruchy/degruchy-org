...
upload :
	aws s3 sync $(shell pwd) s3://degruchy-org --quiet --exclude ".git**" --exclude ".aws**" --exclude ".vscode**" --exclude "*.code-workspace" --exclude ".idea**" --exclude ".editorconfig" --exclude "Makefile" --exclude ".kateproject" --exclude "tasks.rec" --exclude ".fslckout"
